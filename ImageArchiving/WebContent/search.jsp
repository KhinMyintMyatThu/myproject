			...
			<div class="container w3-center"
				...
				<div class="w3-row-padding w3-padding-large w3-center"
					...
					<div
						...
						<a href="DeletePhoto?photoid=<%=photoIdByKeyword.get(i)%>"><i
				...
				<div class="w3-row-padding w3-padding-large w3-center"
					...
					<div
						...
						<a href="DeletePhoto?photoid=<%=photoIdByPeople.get(i)%>"><i
							class="fa fa-trash w3-large" style="float: right; color: red"></i></a>
					</div>
				...
				<div class="w3-row-padding w3-padding-large w3-center"
					...
					<div
						...
						<a href="DeletePhoto?photoid=<%=photoIdByTagPeople.get(i)%>"><i
							class="fa fa-trash w3-large" style="float: right; color: red"></i></a>
					</div>
