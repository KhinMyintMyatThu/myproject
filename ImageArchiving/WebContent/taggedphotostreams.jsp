				...
				<table>
					<tbody>
						<tr>
							...
							<td width="60px;" style="padding-left: 20px;"><a href="Logout" title="Logout"><i
			...
			<div class="container w3-center"
				...
				<div class="w3-row-padding w3-padding-large w3-center"
					...
					<div
						...
						<a href="DeletePhoto?photoid=<%=photoId.get(i)%>"><i class="fa fa-trash w3-large" style="float:right; color:red"></i></a>
					</div>
					<%
							}
